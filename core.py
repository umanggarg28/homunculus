...
- python_exec(code): run Python code in a sandbox container (no network, 256MB cap, 30s timeout). Returns stdout/stderr. Use for math, parsing, computation, verification. Cannot persist files.
